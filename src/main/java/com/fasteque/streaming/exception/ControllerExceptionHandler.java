package com.fasteque.streaming.exception;

import com.fasteque.streaming.controller.ApiResponseEntityFactory;
import com.fasteque.streaming.domain.FFMpegProbe;
import com.fasteque.streaming.logging.ErrorLogger;
...
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleMaxUploadSizeExceeded(Throwable ex) {
        return responseFactory.badRequest(format("Upload size exceeded, request was too big. Max request size is %s and for file %s", maxRequestSize, maxFileSize));
    }

    @ExceptionHandler({FFMpegProbe.ProbeException.class})
    public ResponseEntity<Object> handleVideoProbeException(FFMpegProbe.ProbeException ex) {
        return responseFactory.internal("Problem with probing file", errorLogger.logError(ex));
    }
